...
public class CylindricalActivity extends Activity {
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.cylindrical);
	 	...
	 	btn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				try{
					...
					Double Answer = Math.PI*Math.pow(r1, 2)*r2; 
					if(r1 <=1000){
					tv.setText("Volume of a cylinder :" + Answer);
					}else{
					tv.setText("คุณสามารถใส่ค่าสูงสุดได้ไม่เกิน  1000");
						}		
